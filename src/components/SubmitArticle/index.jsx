...
const SubmitArticle = () => {
  return (
    <div className="ms-3 ps-5 pe-5" id="submissionForm">
      <h2 className="card-title text-center display-5 pageTitle">
      ...
      <div className="row">
        ...
        <div className="col-3 mt-2">
          <div className="input-group pasteFields">
            <span className="input-group-text pastePlusSection" id="confCopy">
              +
            </span>
            <input
              type="text"
              className="pasteField form-control"
              placeholder="Link a confluence article"
              aria-label="confluenceCopyField"
              aria-describedby="confCopy"
            />
          </div>
          <div className="input-group pasteFields mt-2 ">
            <span className="input-group-text pastePlusSection" id="kbCopy">
              +
            </span>
            <input
              type="text"
              className="pasteField col-3 form-control"
              placeholder="Link a knowledgebase article"
              aria-label="kbCopyField"
              aria-describedby="kbCopy"
            ></input>
          </div>
        </div>
        <div className="row d-flex justify-content-end mt-2 ">
          <button id="submit" className="btn btn-success col-3">
            Submit
          </button>
        </div>
      </div>
